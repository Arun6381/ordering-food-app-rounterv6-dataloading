    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <input
            className=" grow rounded-2xl px-3"
            type="text"
            name="customer"
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            <input
              className=" w-full rounded-2xl px-3"
              type="tel"
              name="phone"
              required
            />
        ...
        <div className="mb-12 flex items-center gap-5">
          <input
            className=" accent-yellow-400 focus:outline-none focus:ring focus:ring-yellow-400 focus:ring-offset-1"
            type="checkbox"
            name="priority"
            id="priority"
            value={withPriority}
